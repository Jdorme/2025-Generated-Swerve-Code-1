...
public class FloorIntakePositionCommand extends Command {
    ...
    public FloorIntakePositionCommand(SafetySubsystem safetySystem, ArmSubsystem arm, 
        ...
        switch (currentState) {
            case MOVE_TO_STOW:
                ...
                if (areBothAtTarget(SafetyConstants.STOWED[0], SafetyConstants.STOWED[1])) {
                    ...
                    m_arm.setAngle(SafetyConstants.GROUND_ALGAE[1]);
                }
                break;
                
            case ARM_TO_FLOOR:
                // Wait for arm to reach floor position
                if (isArmAtTarget(SafetyConstants.GROUND_ALGAE[1])) {
                    ...
                    m_elevator.setHeight(SafetyConstants.GROUND_ALGAE[0]);
                }
                break;
                
            case ELEVATOR_TO_FLOOR:
                // Wait for elevator to reach floor position
                if (isElevatorAtTarget(SafetyConstants.GROUND_ALGAE[0])) {
